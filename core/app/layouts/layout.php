...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Embragues JF | Dashboard</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>EMBRAGUES</b>JF</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="">
                      <a href="https://lucerna-2017.web.app/" target="_blank" class="">Ir a Lucerna</a>
                      <a href="https://lucerna-2017.web.app/" target="_blank" class="">Ver</a>
                  </li>
...
<div class="user-panel">
    ...
    <?php endif;?>
      ...
      <div class="content">
        ...
        <strong>Copyright &copy; 2021 <a href="https://lucerna-2017.web.app/" target="_blank">Cesar Gonzalez</a></strong>
      </footer>
      <?php else:?>
<div class="login-box">
      <div class="login-logo">
        <a href="./">EMBRAGUES<b>JF</b></a>
      </div><!-- /.login-logo -->
